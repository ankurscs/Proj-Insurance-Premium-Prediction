...
if __name__=="__main__":
    try:
        ...
        logging(f"getting the model_trainer_config {model_trainer_config}")
        model_trainer = ModelTrainer(model_trainer_config=model_trainer_config, data_transformation_artifact=data_transformation_artifact)
        logging(f"getting the model_trainer: {model_trainer}")
        logging(f"Starting model model_trainer_artifact")
