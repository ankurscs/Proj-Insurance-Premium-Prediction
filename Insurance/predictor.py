...
# 3
    ...
    def get_latest_transformer_path(self):
        try:
            ...
            return os.path.join(latest_dir, self.transfomer_dir_name,TRANSFORM_OBJECT_FILE_NAME)
        except Exception as e:
            raise e
...
# 7
    def get_latest_save_transfomer_path(self):
        try:
            latest_dir = self.get_latest_save_dir_path()
            return os.path.join(latest_dir, self.transfomer_dir_name, TRANSFORM_OBJECT_FILE_NAME) # transform.pkl
        except Exception as e:
            raise e
